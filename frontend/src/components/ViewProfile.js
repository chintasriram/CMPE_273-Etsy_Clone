        ...
        <MainNavbar />
         <div className="view_profile_home_body">
            {!gettingCurrency && !gettingFavoriteItems && !gettingCountries && !viewProfileLoading && <div>
                    ...
                    <Button className='changeColor' onClick={(e)=>{e.preventDefault(); navigate("/edit-profile")}}>Update Profile </Button>
                    </div>
                   {/*} <div className='col-md-2'> 
                    <Button className='changeColor' onClick={goToShop}>Shop </Button>
                    </div> */}
                    <div className='col-md-2'> 
                    <Button className='changeColor' onClick={(e)=>{e.preventDefault(); navigate("/orders")}}>My Orders </Button>
                    </div>
